...
const Card = ({name, img, id, link}) => {
  ...
  <div class="p-6 pt-8">
    <Link to={link} data-ripple-light="true" type="button" class="select-none rounded-lg bg-[#a5815d] py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white">
      Read More
    </Link>
  </div>
</div>
