...
import image1 from '../Asstes/Destinations1.jpg';
...
Et doloribus enim ea dolores molestiae aut aliquid voluptatibus et soluta aperiam in modi voluptas ex dolorem quos aut dignissimos nihil. Eos fugiat iure ut molestias assumenda qui cupiditate quos!
                ...
                <div className='w-[95%] min-h-40 h-fit flex justify-evenly items-center flex-col border-b-2 border-[#8c6948cf] '>
                    ...
                    <div className='w-[95%] h-12 flex justify-between items-center my-5'>
                    <input type='text' placeholder='Add your comment . . .' className='w-[80%] h-10 outline-none rounded-lg p-2 border-2 border-[#8c6948cf] text-black'/>
                    <button className='w-[17%] h-10 bg-[#8c6948cf] rounded-lg'>Comment</button>
                </div>
                </div>
            </div>
        </div>
