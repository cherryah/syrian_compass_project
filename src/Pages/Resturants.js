...
//     ]
    ...
    const catagoryAPI='http://127.0.0.1:8000/api/categories/search?classification=restaurant'
    ...
    useEffect(() => {
        catagory()
        localStorage.setItem('place', 'restaurant')
      }, []);
    ...
    <div className='w-screen h-screen bg-center overflow-x-hidden bg-no-repeat bg-cover bg-[#d1b798]'>
        ...
        <div className='w-[100%] h-fit text-white flex justify-center items-center flex-col mt-10'>
            <div className='w-[90%] h-20 flex justify-between items-center'>
                <h2 className='w-[90%] text-4xl font-semibold'>Resturants</h2>
                <button className='w-40 h-[60%] text-lg hover:bg-[#8c69488c] bg-[#8c6948b6] rounded-2xl' onClick={()=>setShow(true)}>Add resturant</button>
            </div>
